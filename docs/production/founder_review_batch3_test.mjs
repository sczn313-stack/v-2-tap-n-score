...
assert.match(shoot, /Results could not be calculated\. Your confirmed impacts are preserved\. Try Show Results again\./, "unexpected-result recovery copy is concise and actionable");
assert.match(shoot, /SCZN3 cannot reach the analysis service\. Check your connection/, "connection guidance is reserved for an actual network failure");
assert.match(shoot, /analysis service is temporarily unavailable\. Your confirmed impacts are preserved/, "backend availability has truthful recovery guidance");
