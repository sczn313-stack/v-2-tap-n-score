...
assert.match(source["shoot.html"], /zeroingLivePhase = "confirmation"/);
assert.match(source["shoot.html"], /sourceIsZeroingSession\(candidate\)/);
...
assert.doesNotMatch(source["sec.html"], /href="sec\.html"[^>]*aria-current="page"/);
assert.doesNotMatch(source["records.html"], /href="records\.html"[^>]*aria-current="page"/);
assert.doesNotMatch(source["matrix.html"], /href="matrix\.html"[^>]*aria-current="page"/);
