...
assert(
  /\.records-page \.sec-gssf-bucket-grid\s*\{[^}]*grid-template-columns:1fr[^}]*width:100%[^}]*min-width:0[^}]*max-width:100%/s.test(mobileStyles),
  "Authoritative bucket grid must stay within its narrow-mobile parent"
);
assert(
