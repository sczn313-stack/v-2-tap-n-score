...
assert(/@media\(max-width:460px\)\{[\s\S]*?\.records-page \.sec-gssf-evidence-grid \.sec-comparison-target\{min-height:600px\}/.test(m4Styles), "stacked 390px GSSF evidence panels must retain one equal governed footprint");
